...
export default function KineticGrid({
  ...
  children?: ReactNode;
  className?: string;
  globalColor?: "default" | "monochrome" | "amber";
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      // Background (only when not transparentBg)
      if (!transparentBg && theme.bg) {
  ...
  return (
    <div
      className={cn(
        ...
        !transparentBg && (globalColor === "monochrome" ? "bg-[#000000]" : "bg-[#161618]"),
        className,
      )}
    >
      <canvas
